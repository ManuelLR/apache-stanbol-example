package com.mycompany.stanbol.isbn.engine;
...
public class ISBNDetectorEngine implements EnhancementEngine, ServiceProperties {
	...
	public void computeEnhancements(ContentItem ci) throws EngineException {
		...
		try {
			...
			throw new InvalidContentException(this, ci, String.format(
					"Unable to extract "
	...
	public static IRI createTextEnhancement(String selected, int start,
